...
(function() {
  jQuery(function() {
    ...
    $("#micropost_content").keyup(function() {
      ...
      if (text_remaining <= 0 && !$(".char-counter").hasClass("red-text")) {
        return $(".char-counter").addClass("red-text");
      } else if (text_remaining > 0 && $(".char-counter").hasClass("red-text")) {
        return $(".char-counter").removeClass("red-text");
      }
    });
